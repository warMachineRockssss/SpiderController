...
# scrapy crawl xbSpider -o test.jsonlines
class LinkSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        # 获取当前页面中的所有链接
        movie_item_list = rendered_response.css('.col-lg-8.col-md-6.col-sm-4.col-xs-3')
        ...
        for element in movie_info_list:
            if element.get('movie_addr') is not None:
                ...
                yield scrapy.Request(
                    url="https://xbyy.cc/vod/play/" + element.get('movie_addr') + "-v.html",
